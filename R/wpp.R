...
get.available.wpps <- function() c(2008, 2010, 2012, 2015, 2017, 2019, 2022, 2024)
...
ind.digits <- function(indicator) ind.settings()[indicator, 'digits_hist']
ind.digits.tbl <- function(indicator) ind.settings()[indicator, 'digits_tbl']
